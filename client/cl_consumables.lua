...
RegisterNetEvent('randol_burgershot:client:makeSoda', function()
    ...
    if ingredients then
        TriggerEvent('animations:client:EmoteCommandStart', {"cocoa"})
...
RegisterNetEvent('randol_burgershot:client:cookBurgers', function()
    SetEntityCoords(PlayerPedId(), -1195.7, -898.12, 12.89)
    SetEntityHeading(PlayerPedId(), 338.11)
...
RegisterNetEvent('randol_burgershot:client:drinkStation', function()                    
    SetEntityCoords(PlayerPedId(), -1191.2, -898.48, 12.89)
    SetEntityHeading(PlayerPedId(), 209.76)
    exports['qb-menu']:openMenu({
        {
